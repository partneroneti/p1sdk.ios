...
class AdditionalReviewAnimationView: UIView
{
    ...
    private func setupLayers()
    {
        ...
        let strokeColor1 = UIColor(red: 0, green: 0.502, blue: 0.729, alpha: 1)
        ...
        magnifierLayer.allowsGroupOpacity = true
            ...
            // FaceTec
            //
            let faceTecLayer = CALayer()
            faceTecLayer.name = "FaceTec"
            faceTecLayer.bounds = CGRect(x: 0, y: 0, width: 46.428, height: 46.428)
            faceTecLayer.position = CGPoint(x: 0, y: 0)
            faceTecLayer.anchorPoint = CGPoint(x: 0, y: 0)
            faceTecLayer.contentsGravity = kCAGravityCenter
            faceTecLayer.shadowOffset = CGSize(width: 0, height: 1)
            faceTecLayer.allowsEdgeAntialiasing = true
            faceTecLayer.allowsGroupOpacity = true
            faceTecLayer.fillMode = kCAFillModeForwards
                ...
                faceTecLayer.addSublayer(strokeLayer2)
                ...
                faceTecLayer.addSublayer(strokeLayer3)

            magnifierLayer.addSublayer(faceTecLayer)
