...
class AdditionalReviewAnimationViewOrange: UIView
{
    ...
    private func setupLayers()
    {
        ...
        let strokeColor1 = UIColor(red: 0.969, green: 0.588, blue: 0.204, alpha: 1)
        ...
        magnifierLayer.allowsGroupOpacity = true
            ...
            // Bitcoin
            //
            let bitcoinLayer = CALayer()
            bitcoinLayer.name = "Bitcoin"
            bitcoinLayer.bounds = CGRect(x: 0, y: 0, width: 46.428, height: 46.428)
            bitcoinLayer.position = CGPoint(x: 0, y: 0)
            bitcoinLayer.anchorPoint = CGPoint(x: 0, y: 0)
            bitcoinLayer.contentsGravity = kCAGravityCenter
            bitcoinLayer.shadowOffset = CGSize(width: 0, height: 1)
            bitcoinLayer.allowsEdgeAntialiasing = true
            bitcoinLayer.allowsGroupOpacity = true
            bitcoinLayer.fillMode = kCAFillModeForwards
                ...
                bitcoinLayer.addSublayer(strokeLayer2)
                ...
                bitcoinLayer.addSublayer(strokeLayer3)

            magnifierLayer.addSublayer(bitcoinLayer)
