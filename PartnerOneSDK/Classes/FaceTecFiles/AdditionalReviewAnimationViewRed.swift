...
class AdditionalReviewAnimationViewRed: UIView
{
    ...
    private func setupLayers()
    {
        ...
        let strokeColor1 = UIColor(red: 0.929, green: 0.110, blue: 0.141, alpha: 1)
        ...
        magnifierLayer.allowsGroupOpacity = true
            ...
            magnifierLayer.addSublayer(ekycLayer)
