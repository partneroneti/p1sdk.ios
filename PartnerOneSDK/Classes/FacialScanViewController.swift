...
//      Config.PublicFaceScanEncryptionKey = self.helper.faceTecPublicFaceScanEncryptionKey
      ...
      FacetecUtils.initializeFaceTecSDKFromAutogeneratedConfig(
        with: self.helper.faceTecProductionKeyText,
        deviceKeyIdentifier: self.helper.faceTecDeviceKeyIdentifier,
        faceScanEncryptionKey: self.helper.faceTecPublicFaceScanEncryptionKey,
